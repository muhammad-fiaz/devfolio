...
**Tip:** Run `bun format:fix` to format your code before submitting your PR.

### File Structure

Our docs use file-system routing. Each folder and file in `/` represents a route segment for URLs, navigation, and breadcrumbs.

For example, to contribute to "Authentication," place the file in:

```
content/projects/authentication.mdx
```
